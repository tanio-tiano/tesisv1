...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=(
            "../experiments/cec_baseline_30runs/values/"
            "summary_wo_base_cec2022_30x500_30runs.csv"
        ),
...
def main():
    ...
    tests_path = output_dir / "normality_tests_wo_base_cec2022_30runs.csv"
    report_path = output_dir / "normality_report_wo_base_cec2022_30runs.html"
